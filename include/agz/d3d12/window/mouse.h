...
public:
    ...
    AGZ_D3D12_DECL_EVENT_MGR_HANDLER(eventMgr_, MouseButtonDownEvent)
    AGZ_D3D12_DECL_EVENT_MGR_HANDLER(eventMgr_, MouseButtonUpEvent)
    AGZ_D3D12_DECL_EVENT_MGR_HANDLER(eventMgr_, CursorMoveEvent)
    AGZ_D3D12_DECL_EVENT_MGR_HANDLER(eventMgr_, WheelScrollEvent)
