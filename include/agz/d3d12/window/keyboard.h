...
public:
    ...
    AGZ_D3D12_DECL_EVENT_MGR_HANDLER(eventMgr_, KeyDownEvent)
    AGZ_D3D12_DECL_EVENT_MGR_HANDLER(eventMgr_, KeyUpEvent)
    AGZ_D3D12_DECL_EVENT_MGR_HANDLER(eventMgr_, CharInputEvent)
    AGZ_D3D12_DECL_EVENT_MGR_HANDLER(eventMgr_, RawKeyDownEvent)
    AGZ_D3D12_DECL_EVENT_MGR_HANDLER(eventMgr_, RawKeyUpEvent)
